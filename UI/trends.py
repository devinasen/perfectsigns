#trends page, heatmaps + graphing tool
...
df = pd.read_csv('../model/Data Collection Survey (Responses).csv')
og_df = pd.read_csv('../model/Data Collection Survey (Responses).csv')
